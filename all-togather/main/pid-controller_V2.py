...
def MR3(Ki):
    ...
    Ki_follow = -1
    while Ki > Ki_follow:
        Ki_follow = random.uniform(0.02, 0.1)
    Kd = random.uniform(0.5, 10)
...
def metamorphic_test(num_trials):
    ...
    for i in range(0, num_trials):
        ...
        # print(result)
        #
        # Setpoint_Source12 = Setpoint_Source   ==============================================================
        # Systemstatus_Source12 = Systemstatus_Source
        # Source_difference = Setpoint_Source12 - Systemstatus_Source12
        # # Kp12 = random.uniform(1 + Source_difference, 8 + Source_difference)
        # Kp12 = random.uniform(1, 8)
        # while Source_difference >= Kp12 or Kp12 >= Source_difference * 2:
        #     Setpoint_Source12 = random.randrange(1, 8)
        #     Systemstatus_Source12 = random.randrange(1, 8)
        #     Source_difference = Setpoint_Source12 - Systemstatus_Source12     ==========================================================

        # print(Systemstatus_Source12,Setpoint_Source12,Kp12)
        print(Setpoint_Source,Systemstatus_Source,Kp)
    ...
    #     print(f'---------------------------------  faulty flag is {faulty} for iteration {i}  ----------------------------------------------------')
    # print(result)
